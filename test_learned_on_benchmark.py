...
parser.add_argument(
    "--Pn_j", type=int, default=30, help="Number of jobs of instances to test"
)
parser.add_argument(
    "--Pn_m", type=int, default=20, help="Number of machines instances to test"
)
parser.add_argument(
    "--Nn_j",
    type=int,
...
parser.add_argument(
    "--which_benchmark", type=str, default="tai", help="Which benchmark to test"
)
...
dataLoaded = np.load(
    "./BenchDataNmpy/" + benchmark + str(N_JOBS_P) + "x" + str(N_MACHINES_P) + ".npy"
)
dataset = []
