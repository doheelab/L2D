...
def test(dataset):
    ...
    np.save(
        ...
        + "_Seed"
        + str(SEED),
        np.array(result, dtype=np.single),
    )
    # print(np.array(result, dtype=np.single).mean())
...
if __name__ == "__main__":
    ...
    # parser.add_argument(
    #     "--Pn_j", type=int, default=15, help="Number of jobs of instances to test"
    # )
    # parser.add_argument(
    #     "--Pn_m", type=int, default=15, help="Number of machines instances to test"
    # )
    # parser.add_argument(
    #     "--Nn_j",
    #     type=int,
    ...
    # parser.add_argument(
    #     "--seed", type=int, default=200, help="Seed for validate set generation"
    # )
    ...
    # How to get the obtained schedule from RL agent?
    # you can find the finish time for each operation by:
    env.LBs.reshape(N_JOBS_N, N_MACHINES_N)
