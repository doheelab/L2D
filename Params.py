...
# # args for device
# parser.add_argument(
#     "--device", type=str, default="cuda", help="Number of jobs of instances"
# )
# # args for env
...
# )
# parser.add_argument(
#     "--neighbor_pooling_type", type=str, default="sum", help="neighbour pooling type"
# )
# parser.add_argument(
...
# )
# parser.add_argument(
#     "--hidden_dim", type=int, default=64, help="hidden dim of MLP in fea extract GNN"
# )
# parser.add_argument(
...
# parser.add_argument(
#     "--decay_ratio", type=float, default=0.9, help="decay_ratio, e.g. 0.9, 0.95"
# )
